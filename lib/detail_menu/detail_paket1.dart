...
class DetailPaket1 extends StatefulWidget {
  const DetailPaket1({Key? key}) : super(key: key);

  @override
  State<DetailPaket1> createState() => _DetailPaket1();
}

class _DetailPaket1 extends State<DetailPaket1> {
  ...
  int dataPrice = 35000;
  int dataPricePromo = 30000;

  int price = 35000;
  int pricePromo = 30000;
